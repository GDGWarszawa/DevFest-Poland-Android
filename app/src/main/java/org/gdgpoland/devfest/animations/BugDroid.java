package org.gdgpoland.devfest.animations;
...
public class BugDroid implements View.OnClickListener {
    ...
    public void startAnimation() {
        ...
        if (Utils.isLollipop()) {
            ...
            anim.addListener(new org.gdgpoland.devfest.animations.SimpleAnimatorListener() {
            ...
            fadeIn.setAnimationListener(new org.gdgpoland.devfest.animations.SimpleAnimationListener(){
                @Override
        ...
        if (Utils.isLollipop()) {
            ...
            anim.addListener(new org.gdgpoland.devfest.animations.SimpleAnimatorListener() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    outAnimation.setAnimationListener(new org.gdgpoland.devfest.animations.SimpleAnimationListener() {
                        @Override
                        public void onAnimationEnd(Animation animation) {
                            stopAnimation();
                        }
